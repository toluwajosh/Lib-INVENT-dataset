...
from dto import (
    ...
    StatsExtractionConfig,
    FileShufflingConfig,
    ReactionValidationConfig,
)
...
class Manager:
    ...
    def _data_randomization(self):
        config = from_dict(
            data_class=RandomizationConfig, data=self._configuration.parameters
        )
    ...
    def _reaction_based_slicing(self):
        config = from_dict(
            data_class=ReactionBasedSlicingConfig,
    ...
    def _duplicate_removal(self):
        config = from_dict(
            data_class=DuplicateRemovalConfig,
            data=self._configuration.parameters,
        )
    ...
    def _file_shuffling(self):
        config = from_dict(
            data_class=FileShufflingConfig, data=self._configuration.parameters
        )
    ...
    def _reaction_validation(self):
        config = from_dict(
            data_class=ReactionValidationConfig,
            data=self._configuration.parameters,
        )
    ...
    def _reagent_validation(self):
        config = from_dict(
            data_class=ReagentValidationConfig,
            data=self._configuration.parameters,
        )
    ...
    def _stats_extractor(self):
        config = from_dict(
            data_class=StatsExtractionConfig,
            data=self._configuration.parameters,
        )
    ...
    def _tensorboard_extractor(self):
        config = from_dict(
            data_class=TensorboardStatsExtractionConfig,
            data=self._configuration.parameters,
        )
    ...
    def _scaffold_memory_analyser(self):
        config = from_dict(
            data_class=ScaffoldMemoryAnalysisConfig,
            data=self._configuration.parameters,
        )
    ...
    def run(self):
        registry = {
            self._running_mode.RANDOMIZATION: self._data_randomization,
        ...
        run_type = registry.get(
            self._configuration.run_type, lambda: TypeError
        )
        run_type()
